...
function EmailStateChanged() 
{
	...
	$main_content .= '<TR><TD width="150" valign="top"><B>Account number: </B></TD><TD colspan="2"><INPUT type="number" id="account_name" NAME="reg_name" onkeyup="checkAccount();" VALUE="" SIZE=30 MINLENGTH=7 MAXLENGTH=15><BR><font size="1" face="verdana,arial,helvetica">(Please enter your new account number)</font></TD></TR>
					  <TR><TD width="150"><b>Number status:</b></TD><TD colspan="2"><b><div id="acc_name_check">Please enter your account number.</div></b></TD></TR>
...
if($action == "saveaccount")
{
	...
	elseif(!check_account_name($reg_name))
		$reg_form_errors[] = "Invalid account number format. Use only numbers 0-9 and between 7-11 characters.";
	if(empty($reg_email))
